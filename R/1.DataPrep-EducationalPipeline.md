...
Samples with **fewer than 5141 reads** (as determined by earlier quality control) will be filtered out to ensure data quality.
...
Sometimes samples may appear more than once due to **genotype updates**. We’ll remove duplicates by keeping only the first occurrence.
